...
from complexnetwork.CDSCNN.utils import ComplexConv1d, ComplexBatchNorm, CReLU, ComplexAvgPool2d, ComplexLinear, ComplexMaxPool1d
from complexnetwork.CDSCNN.CDSC import CDSC1d
